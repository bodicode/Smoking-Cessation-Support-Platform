  ...
  return (
    <div className="min-h-screen bg-br from-[#e3f6ff] via-[#fefcf6] to-[#fff7f1] py-10 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <h1 className="text-3xl font-bold text-[#03256c] mb-2">Profile Quiz Management</h1>
          <p className="text-gray-500 mb-6">Create and manage profile assessment quizzes for users</p>
