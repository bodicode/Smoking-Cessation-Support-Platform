            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
                <div className="lg:col-span-2 flex flex-col gap-12">
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-12 text-red-500">Lỗi tải dữ liệu blogs.</div>
                    ) : blogs.length === 0 ? (
                        <div className="text-center py-12 text-gray-400">Không có blog nào.</div>
                    ) : (
                        blogs.map((blog: any) => (
                            <Link
                                ...
                                <div className="flex-1 flex flex-col justify-between">
                                    <div>
                                        <div className="flex gap-3 items-center text-sm text-gray-400 mb-2">
                                            <span>{blog.created_at?.split('T')[0]?.split('-').reverse().join('.') || ""}</span>
                                        </div>
                            ...
                            {mostPopular.map((item: any) => (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500">
                                            {item.author?.name} - {item.created_at?.split('T')[0]?.split('-').reverse().join('.') || ""}
                                        </div>
                                    </div>
                                </Link>
                            ))}
