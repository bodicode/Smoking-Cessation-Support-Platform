  ...
  return (
    <div className="max-w-4xl mx-auto mt-8">
      <div className="bg-white rounded-2xl shadow-lg p-8">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-[#03256C] mb-1">Quản lý báo cáo</h1>
          <p className="text-gray-500 text-sm">Quản lý báo cáo</p>
        </div>
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          ...
          >
            ...
            {statusKeys.map(status => <option key={status} value={status}>{status}</option>)}
          </select>
        </div>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left font-semibold text-gray-700 whitespace-nowrap">Tên báo cáo</th>
                <th className="px-6 py-3 text-left font-semibold text-gray-700 whitespace-nowrap">Ngày</th>
                <th className="px-6 py-3 text-left font-semibold text-gray-700 whitespace-nowrap">Trạng thái</th>
                <th className="px-6 py-3 text-left font-semibold text-gray-700 whitespace-nowrap">Hành động</th>
              </tr>
            </thead>
            <tbody>
              {pagedReports.map((report, idx) => (
                <tr key={idx} className={idx % 2 === 0 ? "bg-white" : "bg-gray-50" + " hover:bg-blue-50 transition-colors"}>
                  ...
                  <td className="px-6 py-3 whitespace-nowrap">{report.status}</td>
