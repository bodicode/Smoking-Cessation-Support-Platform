...
export default function PlanTemplateDetail() {
  ...
  return (
    <motion.div
      className="max-w-7xl mx-auto my-10 bg-white rounded-2xl p-8 border border-gray-100"
    ...
    >
      ...
      />
      <motion.h1
        className="text-3xl font-extrabold text-center text-sky-700 mb-2 tracking-tight"
        ...
        >
          ...
          <div className="flex items-center gap-3 text-gray-600">
            ...
            <span className="font-normal">
              {translateDifficulty(template.difficulty_level)}
            </span>
          </div>
          <div className="flex items-center gap-3 text-gray-600">
      ...
      <motion.ol
        ...
        variants={{
          hidden: {},
          visible: {
            transition: { staggerChildren: 0.13, delayChildren: 0.6 },
          },
        }}
      >
