...
export default function SmokeFreeStats({
    ...
    stages,
    totalMoneySaved,
}: SmokeFreeStatsProps & { stages?: any[], totalMoneySaved?: number }) {
    if (loading) return <Loading />;

    return (
        <div className="max-w-7xl mx-auto bg-gradient-to-br from-[#F2F9F1] to-[#D6ECE1] shadow-xl rounded-3xl p-8 md:p-12 flex flex-col gap-8 border border-[#bde8ce] mb-12">
            ...
            <div className="mt-4">
                <h3 className="font-bold text-3xl mb-3 text-[#01613B] text-center">Biểu đồ quá trình kế hoạch</h3>
                <SmokeFreeChart records={records} stages={stages || []} />
            </div>
