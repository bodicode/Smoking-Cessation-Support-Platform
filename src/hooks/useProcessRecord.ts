import { createProgressRecord, getProgressRecords, removeProgressRecord, updateProgressRecord } from "@/services/processRecordService";
...
export function useProgressRecords(planId: string) {
    ...
    return { records, loading, error, handleCreate, reload, setReload, handleUpdate, handleDelete };
}
